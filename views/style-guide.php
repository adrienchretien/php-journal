    ...
    <!-- Titres -->
    <h2>Sections (<a href="#">linked</a>, <b>bold</b>, <i>italic</i>)</h2>
    ...
    <h3>Third-Level Header on multiple lines because we don't know what will happend in the future (<a href="#">linked</a>, <b>bold</b>, <i>italic</i>)</h3>
    ...
    <h4>Fourth-Level Header (<a href="#">linked</a>, <b>bold</b>, <i>italic</i>)</h4>
    ...
    <p class="serif">You can use a serif font on elements instead of the default one by using a <code>.serif</code> class on the element.</p>
...
p q r s t u v w x y z { | } ~</samp></pre>
    ...
    <div>
      <figure>
        <img src="http://lorempixel.com/g/680/396/abstract" alt="Example image"/><!-- 
         --><figcaption>
